    ...
    var PRE_LEAVE_DURATION = 300,
        Conf = {
            firstPreloadRes: [
                ...
                '@@CONTEXT_PATH/img/3w_spread/flash_1.png',
                '@@CONTEXT_PATH/img/3w_spread/flash_2.png',
                '@@CONTEXT_PATH/img/3w_spread/star.png',
                '@@CONTEXT_PATH/img/3w_spread/zhiwen.png',
                '@@CONTEXT_PATH/img/3w_spread/page_1/1.png',
                '@@CONTEXT_PATH/img/3w_spread/page_1/2.png',
                '@@CONTEXT_PATH/img/3w_spread/page_1/3.png',
            ],
            secondPreloadRes: []
        };
